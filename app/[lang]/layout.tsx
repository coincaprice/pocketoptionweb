...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    title: { default: `Pocket Option – ${t.hero.title}`, template: '%s | Pocket Option' },
...
const jsonLd = {
  ...
  description: 'Trade over 100 global assets including forex, cryptocurrencies, stocks, and commodities on Pocket Option.',
  foundingDate: '2017',
  sameAs: [
